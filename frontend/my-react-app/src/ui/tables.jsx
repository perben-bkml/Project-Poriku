...
export function TableDaftarTamu(props) {
                ...
                <TableBody>
                    {props.body.map((row, index) => (
                        <TableRow key={index}>
                            {row.map((data, index) => (
                                <TableCell key={index}>
                                    {tableType === 'masuk' && (index === 9 || index === 10 || index === 11 || index === 12) || tableType === 'keluar' && (index === 10)
                                        ? <a href={data} target="_blank" rel="noopener noreferrer">{ data !== "" ? 'Klik untuk lihat' : ""}</a>
                                        : data}
                                </TableCell>
                            ))}
                        </TableRow>
